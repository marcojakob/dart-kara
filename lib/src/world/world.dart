...
class World extends Sprite {
  ...
  World(this.scenario, this.kara, this.speed) {
    ...
    _loadAssets().then((_) {
      ...
      // Start listening to enter frame events.
  ...
  Future _loadAssets() {
    resourceManager
        ...
        ..addBitmapData('kara_right', '$assetDir/images/kara_right.png')
  ...
  void _checkActionQueue() {
    if (_actionQueue.isNotEmpty) {
      ...
      // No action in queue, call the actors act()-method.
      try {

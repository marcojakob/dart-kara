...
class Scenario {
  ...
  /// 
  /// [actors] is the position of actors in the world. Each list entry 
  /// is a line (y-position) and the position of the character in the String is 
  /// the column (x-position). See [Scenario] class description for a list of
  ...
  Scenario({this.title: 'untitled', this.width: 10, this.height: 10, 
    this.actors: '@', this.karaDirection: directionRight});
